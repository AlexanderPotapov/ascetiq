...
define({
	...
	post: {
		motd: 		'<li id="{id}" style="animation: fadeOut ease 60s; -webkit-animation: fadeOut ease 60s; -moz-animation: fadeOut ease 60s; -o-animation: fadeOut ease 60s; -ms-animation: fadeOut ease 60s;"><i class="motd">{text}</i></li>',
		info: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut ease 60s; -webkit-animation: fadeOut ease 60s; -moz-animation: fadeOut ease 60s; -o-animation: fadeOut ease 60s; -ms-animation: fadeOut ease 60s;"><i class="info">{text}</i></li>',
		server: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut ease 60s; -webkit-animation: fadeOut ease 60s; -moz-animation: fadeOut ease 60s; -o-animation: fadeOut ease 60s; -ms-animation: fadeOut ease 60s;"><i class="server">{text}</i></li>',
		error: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut ease 60s; -webkit-animation: fadeOut ease 60s; -moz-animation: fadeOut ease 60s; -o-animation: fadeOut ease 60s; -ms-animation: fadeOut ease 60s;"><i class="error">{text}</i></li>',
		message: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut ease 60s; -webkit-animation: fadeOut ease 60s; -moz-animation: fadeOut ease 60s; -o-animation: fadeOut ease 60s; -ms-animation: fadeOut ease 60s;"><i class="nick">{nick}</i> <i class="message">{text}</i></li>'
	},
