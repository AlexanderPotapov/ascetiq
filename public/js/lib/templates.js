...
define({
	...
	post: {
		motd: 		'<li id="{id}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s;><i class="motd">{text}</i></li><style>@keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-moz-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-webkit-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-o-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-ms-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}</style>',
		info: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s;><i class="info">{text}</i></li><style>@keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-moz-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-webkit-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-o-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-ms-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}</style>',
		server: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s;><i class="server">{text}</i></li><style>@keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-moz-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-webkit-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-o-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-ms-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}</style>',
		error: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s;><i class="error">{text}</i></li><style>@keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-moz-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-webkit-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-o-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-ms-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}</style>',
		message: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s;><i class="nick">{nick}</i> <i class="message">{text}</i></li><style>@keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-moz-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-webkit-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-o-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}@-ms-keyframes fadeOut{id}{0%{opacity:1}100%{opacity:0}}</style>'
	},
