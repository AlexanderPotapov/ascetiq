...
define({
	...
	post: {
		motd: 		'<li id="{id}" style="-webkit-transition: opacity 60s ease-in-out;
    -moz-transition: opacity 60s ease-out;
    -ms-transition: opacity 60s ease-out;
    -o-transition: opacity 60s ease-out;
     opacity: 0;"><i class="motd">{text}</i></li>',
