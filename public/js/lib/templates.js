...
define({
	...
	post: {
		motd: 		'<li id="{id}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s; @keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-moz-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-webkit-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-o-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-ms-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}
"><i class="motd">{text}</i></li>',
		info: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s; @keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-moz-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-webkit-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-o-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-ms-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}
"><i class="info">{text}</i></li>',
		server: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s; @keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-moz-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-webkit-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-o-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-ms-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}
"><i class="server">{text}</i></li>',
		error: 		'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s; @keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-moz-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-webkit-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-o-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-ms-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}
"><i class="error">{text}</i></li>',
		message: 	'<li id="{id}" title="{timestamp}" style="animation: fadeOut{id} ease 60s; -webkit-animation: fadeOut{id} ease 60s; -moz-animation: fadeOut{id} ease 60s; -o-animation: fadeOut{id} ease 60s; -ms-animation: fadeOut{id} ease 60s; @keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-moz-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-webkit-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-o-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}@-ms-keyframes fadeOut{id} {0% {opacity:1;}100% {opacity:0;}}
"><i class="nick">{nick}</i> <i class="message">{text}</i></li>'
	},
	...
	messages: {
		...
		msg_no_room: 			'You have to join a room before sending messages. Try refresh this page. See /help.',
